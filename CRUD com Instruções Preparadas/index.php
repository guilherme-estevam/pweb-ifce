  ...
  <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id=updateForm action="update.php" method="get" onkeypress="return event.keyCode != 13;">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" onclick="getKey()">Atualizar</button>
          </div>
        </form>
      </div>
    </div>
